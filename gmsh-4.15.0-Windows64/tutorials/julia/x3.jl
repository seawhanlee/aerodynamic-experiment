...
# list-based data (see e.g. `t7.jl', `t8.jl' and `t9.jl'), independently of any
# mesh.
...
println("View ", t1, " has ", ns, " time steps")

# Views can be queried and modified in various ways using plugins (see `t9.jl'),
# or probed directly using `gmsh.view.probe()' - here at point (0.9, 0.1, 0):
println("Value at (0.9, 0.1, 0) = ", gmsh.view.probe(t1, 0.9, 0.1, 0))
